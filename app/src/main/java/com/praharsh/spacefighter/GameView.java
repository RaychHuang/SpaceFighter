...
public class GameView extends SurfaceView implements Runnable {
    ...
    private void update() {
        ...
        if (Rect.intersects(player.getDetectCollision(), enemies.getDetectCollision())) {
            ...
            enemies.setX((int) - 2 * enemies.getbitmapWidth());
            ...
            if (flag) {
                ...
                if (enemies.getDetectCollision().exactCenterX() <= -0.45*enemies.getbitmapWidth()) {
    ...
    private void draw() {
        if (surfaceHolder.getSurface().isValid()) {
            ...
            canvas.drawText("Chance: " + ( 3 - countMisses), 100, 50, paint);
